...
url=input("URL:{"ServiceName":"com.ctc.igd1","Params":[{"InterfaceName":"com.ctc.igd1.LED","Properties":[{"Status":"ON"}],"ObjectPath":"\/com\/ctc\/igd1\/Config\/Peripheral\/LED"}],"SequenceId":"20626","RPCMethod":"SetPropertyValues"}")
